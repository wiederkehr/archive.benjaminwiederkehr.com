...
<!-- You can start editing here. -->
	...
	<?php if ($comments) : ?>
	<h3 class="ui" id="comments_heading"><?php comments_number('No Responses', 'One Response', '% Responses' );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
	<ol class="commentlist">

	<?php foreach ($comments as $comment) : ?>

		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<div class="span-18 last comments_item">
				<div class="comment_left span-6">
				<dl class="comments_meta">
					<dt>Name</dt><dd><?php comment_author_link() ?></dd>
					<dt>Date</dt><dd><?php comment_date('F jS, Y') ?></dd>
					<dt>Time</dt><dd><?php comment_time() ?></dd>
				</dl>
				<?php if ($comment->comment_approved == '0') : ?>
				<em>Your comment is awaiting moderation.</em>
				<?php endif; ?>
			</div><!-- .comment_left -->
			<div class="comment_right span-12 last">
				<?php comment_text() ?>
			</div><!-- .comment_right span-12 -->
			</div>
		</li>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<h3 class="ui" id="respond">Leave a Reply</h3>
